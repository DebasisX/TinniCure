...
import 'package:sample/calc.dart';
                                      ...
                                      onChanged: (_value) {
                                        setState(() {
                                          ...
                                          SoundGenerator.setFrequency(
                                              this.frequency);
                                          fvalue=this.frequency.toStringAsFixed(2);
                                        });
                                      }),
                                )
                              ])),
                            ...
                            builder: (context) {
                              return TextButton(
                                ...
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(builder: (context) => calc(myString: fvalue),),
                                  );
                                },
                                child: Column(
                                  children: [
